package com.company.botadminpanel.config.jwtFilter;

import com.company.botadminpanel.model.Admin;
import com.company.botadminpanel.service.auth.AuthServiceImpl;
...
public class JWTFilter extends OncePerRequestFilter {
    ...
    private void setAuthenticationBearer(HttpServletRequest request, String authorization) {
        ...
        if (userId != null) {
            ...
            Optional<Admin> optionalUser = authServiceImpl.findUserById(Integer.valueOf(userId));
